...
// Nhúng mã HTML của bạn vào đây (đã được tối ưu hóa chuỗi)
...
@interface EliteMenu : NSObject <WKScriptMessageHandler>
...
- (void)initMenu {
    ...
    self.webView = [[WKWebView alloc] initWithFrame:window.bounds configuration:config];
    self.webView.backgroundColor = [UIColor clearColor];
    self.webView.opaque = NO;
    
    // Cho phép hiển thị đè lên game
